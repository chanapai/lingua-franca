...
from lingua_franca.lang.format_th import *
...
def nice_number(number, lang=None, speech=True, denominators=None):
    ...
    if lang_code == "en":
        ...
        return nice_number_th(number, speech, denominators)
...
def nice_time(dt, lang=None, speech=True, use_24hour=False,
    ...
    if lang_code == "en":
        ...
        return nice_time_th(dt, speech, use_24hour, use_ampm)
...
def pronounce_number(number, lang=None, places=2, short_scale=True,
    ...
    if lang_code == "en":
        ...
        return pronounce_number_th(number, places=places,
                                   short_scale=short_scale,
                                   scientific=scientific,
                                   ordinals=ordinals)
